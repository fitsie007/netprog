...
public class RunEmailClient {
    ...
    public static void main(String args[]) {
        try {
            ...
            String server = ProjectConstants.DEFAULT_SERVER;
            ...
            opensslCommand += server + ProjectConstants.COLON +ProjectConstants.PORT;
            ...
            if (loginMsg.equals(ProjectConstants.SUCCESS)) {
